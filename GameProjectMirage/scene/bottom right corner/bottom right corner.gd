...
func _ready():
	...
	$"Monster of Sexuality".visible = false
...
func _on_Button_pressed():
	...
	$"Monster of Sexuality".visible = true
	$Button.visible = false
	Music.clickSound()
	pass # Replace with function body.


func _on_Monster_of_Sexuality_pressed():
	#$"Little Fairy Text".modulate.a = 0
	#$"Little Fairy Text2".modulate.a = 1
	#$"Little Fairy box2".modulate.a = 0
	#$"Little Fairy Image".modulate.a = 0
...
func _on_Option1_pressed():
	get_tree().change_scene("res://scene/bottom right corner/bottom right corner1.tscn")
	Music.clickSound()
	pass # Replace with function body.


func _on_Option2_pressed():
	get_tree().change_scene("res://scene/bottom right corner/bottom right corner2.tscn")
	Music.clickSound()
	pass # Replace with function body.
